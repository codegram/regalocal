defmodule RegalocalWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      summary("regalocal.repo.query.total_time", unit: {:native, :millisecond}),
      summary("regalocal.repo.query.decode_time", unit: {:native, :millisecond}),
      summary("regalocal.repo.query.query_time", unit: {:native, :millisecond}),
      summary("regalocal.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("regalocal.repo.query.idle_time", unit: {:native, :millisecond}),
